...
const StatCard = ({ title, value, icon: Icon, color, trend, delay = 0 }) => {
  ...
  return (
    ...
    >
      ...
      <p className="text-2xl font-bold mt-1 text-white">{value ?? 'ΓÇö'}</p>
    </motion.div>
  );
};
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        >
          ...
          <div className="space-y-5">
            ...
            />
            <PlatformBar
              name="Instagram" icon={Camera} count={stats?.overview.accounts.instagram || 0} total={stats?.overview.accounts.total || 1}
